...
| シナリオ | 応答時間 | スループット | コスト削減 | ユースケース |
|----------|---------|------------|-----------|------------|
| **FAQ直接ヒット** | <10ms | 50K QPS | 95% | よくある質問 |
| **ローカルLLM (Llama)** | 50-200ms | 10K QPS | 90% | ホットトピック、プライバシー |
| **クラウドGPT-4** | 500-2000ms | 1K QPS | 0% | 複雑な推論 |
| **ハイブリッドルーティング** | 100ms平均 | 15K QPS | 85% | 本番ワークロード |

*テスト環境: 4 vCPU, 16GB RAM, Redis + Qdrant ローカル*
